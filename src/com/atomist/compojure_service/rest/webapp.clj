(ns com.atomist.compojure-service.rest.webapp
  (:require [clojure.tools.logging :as log]
            [com.stuartsierra.component :as component]
            [compojure.api.sweet :refer :all]
            [ring.util.http-response :refer :all]
            [schema.core :as s])
  (:require [com.atomist.compojure-service.models.status :as m-status]
            [com.atomist.compojure-service.rest.status :as status]))
